...
class GeneratorConfigError(DataForgeException):
    ...
    def __init__(self, message: str, generator_type: Optional[str] = None, invalid_params: Optional[list[str]] = None):
...
class ValidationError(DataForgeException):
    ...
    def __init__(self, message: str, data: Optional[Any] = None, validation_rule: Optional[str] = None):
...
class DataGenerationError(DataForgeException):
    ...
    def __init__(self, message: str, generator_type: Optional[str] = None, context: Optional[dict[str, Any]] = None):
...
class RelationError(DataForgeException):
    ...
    def __init__(self, message: str, field_name: Optional[str] = None, related_field: Optional[str] = None):
...
class APIError(DataForgeException):
    ...
    def __init__(self, message: str, status_code: int = 400, endpoint: Optional[str] = None):
