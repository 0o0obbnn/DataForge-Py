...
class UserBehaviorGenerator(DataGenerator[dict[str, Union[str, int, float, list[Any]]]]):
    ...
    def _generate_user_id(self) -> str:
        """生成用户ID"""
        return f"user_{secrets.randbelow(900000) + 100000}"
    ...
    def _generate_timestamp(self, time_range: str) -> str:
        ...
        if time_range == "recent":
            delta = timedelta(minutes=secrets.randbelow(60 + 1))
        elif time_range == "day":
            delta = timedelta(hours=secrets.randbelow(24 + 1))
        elif time_range == "week":
            delta = timedelta(days=secrets.randbelow(7 + 1))
        elif time_range == "month":
            delta = timedelta(days=secrets.randbelow(30 + 1))
        else:
            delta = timedelta(minutes=secrets.randbelow(60 + 1))
    ...
    def _generate_user_profile(self) -> dict[str, Union[str, int, list]]:
        ...
        # 随机选择3-5个兴趣
        interest_count = secrets.randbelow(3) + 3
    ...
    def _generate_device_info(self) -> dict[str, str]:
        ...
        # 生成设备标识符
        device_id = f"{device_type}_{secrets.randbelow(9000) + 1000}"
