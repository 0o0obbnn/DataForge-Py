...
from dataforge.core.generator import DataGenerator, GeneratorConfig, GeneratorType


class XSSPayloadGenerator(DataGenerator):
    """XSS攻击测试payload生成器"""

    def __init__(self, config: Optional[Union[GeneratorConfig, Mapping[str, Any]]] = None):
        """
    ...
    def validate(self, data: str) -> bool:
        ...
        xss_patterns = [
            '<script', '<img', '<svg', 'javascript:', 'onerror=',
    ...
    # 额外的高级方法
    def generate_payload(self, xss_type: Optional[str] = None, complexity: Optional[str] = None) -> str:
        """生成指定类型的payload"""
    ...
    def get_event_handlers(self) -> list[str]:
        ...
        return [
            ...
            'onmouseout', 'onblur', 'onchange', 'onsubmit', 'onreset'
        ]
