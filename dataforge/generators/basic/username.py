...
class UsernameGenerator(DataGenerator[str]):
    ...
    def _setup(self) -> None:
        ...
        self.style = self.parameters.get("style", "random")  # random, readable, email_style
    ...
    def _generate_random_username(self) -> str:
        ...
        actual_max = max(actual_min, self.max_length - len(self.prefix) - len(self.suffix))
    ...
    def _generate_readable_username(self) -> str:
        """生成可读的用户名"""
        adjectives = [
            "happy", "lucky", "smart", "cool", "fast", "brave", "kind",
            "wise", "bright", "swift", "bold", "calm", "eager", "fair"
        ]
        nouns = [
            "cat", "dog", "fox", "bear", "lion", "tiger", "eagle", "wolf",
            "panda", "dragon", "phoenix", "hawk", "deer", "rabbit"
        ]
    ...
    def _generate_email_style_username(self) -> str:
        ...
        first_parts = [
            ...
            "tom", "mary", "chris", "anna", "james", "lucy", "robert", "emily"
        ]
        last_parts = [
    ...
    def validate(self, data: str) -> bool:
        ...
        # 检查字符集
        core_username = data[len(self.prefix):len(data)-len(self.suffix) if self.suffix else len(data)]
