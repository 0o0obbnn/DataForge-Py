...
class OutputFormatter:
    ...
    def format(self, data, format_type: str = 'json', pretty: bool = False, table_name: str = 'data_table') -> str:
        """格式化输出数据"""
    ...
    def save_to_file(self, data: Dict[str, List[Any]], file_path: str, 
                    format_type: str = 'json', pretty: bool = False):
        """保存数据到文件"""
    ...
    def stream_output(self, data: Dict[str, List[Any]], output_stream: TextIO, 
                     format_type: str = 'json', pretty: bool = False):
        """流式输出数据"""
        formatted_data = self.format(data, format_type, pretty)
