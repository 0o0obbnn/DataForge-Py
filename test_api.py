...
def test_api():
    ...
    for i, record in enumerate(result['data']):
        print(f"     用户{i+1}: {record['name']} | {record['email']} | 年龄{record['age']}")
    print()
