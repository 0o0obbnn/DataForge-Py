...
async def test_stream_price_generator():
    """测试实时价格流生成器"""
    print("🔄 测试实时价格流生成器...")
...
async def test_stream_orderbook_generator():
    """测试实时订单簿流生成器"""
    print("🔄 测试实时订单簿流生成器...")
...
async def test_stream_trade_generator():
    """测试实时交易流生成器"""
    print("🔄 测试实时交易流生成器...")
...
async def test_stream_news_generator():
    """测试实时新闻流生成器"""
    print("🔄 测试实时新闻流生成器...")
...
def test_sync_generators():
    ...
    price_gen = default_factory.create_generator(config)
    ...
    orderbook_gen = default_factory.create_generator(config)
    ...
    trade_gen = default_factory.create_generator(config)
    ...
    news_gen = default_factory.create_generator(config)
...
async def main():
    ...
    try:
        ...
        await test_stream_price_generator()
        await test_stream_orderbook_generator()
        await test_stream_trade_generator()
        await test_stream_news_generator()

        print("\n" + "=" * 50)
        print("🎉 所有实时数据流生成器测试通过！")
