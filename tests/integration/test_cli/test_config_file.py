...
class TestConfigFile:
    ...
    def test_json_config_file(self):
        """测试JSON配置文件"""
        config = {
            "generators": [{"type": "name", "count": 5}, {"type": "age", "count": 5}],
            "output": {"format": "json"},
        }
    ...
    def test_yaml_config_file(self):
        """测试YAML配置文件"""
        config = {
            "generators": [{"type": "name", "count": 3}, {"type": "email", "count": 3}],
            "output": {"format": "csv"},
        }
    ...
    def test_config_with_parameters(self):
        ...
        config = {
            "generators": [
                {"type": "age", "count": 5, "parameters": {"min": 18, "max": 65}}
            ]
        }
    ...
    def test_config_with_output_file(self):
        ...
        try:
            ...
            config = {
                "generators": [{"type": "name", "count": 5}],
                "output": {"file": output_file, "format": "json"},
            }
    ...
    def test_config_override_by_cli_args(self):
        """测试CLI参数覆盖配置文件"""
        config = {"generators": [{"type": "name", "count": 5}]}
