...
class TestSocialInsuranceGenerator:
    ...
    def test_generate_single(self, generator_factory):
        """测试生成单个社保号"""
        from dataforge.generators.identifier.social_insurance import SocialInsuranceGenerator
        generator_factory.registry.register("social_insurance", SocialInsuranceGenerator)
        
        config = GeneratorConfig(
            generator_type="social_insurance",
            parameters={}
        )
