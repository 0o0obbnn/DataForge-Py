...
class TestCommunicationGenerator:
    ...
    def test_generate_single(self, generator_factory):
        ...
        config = GeneratorConfig(generator_type="communication", parameters={})
    ...
    def test_phone_type(self, generator_factory):
        ...
        config = GeneratorConfig(
            generator_type="communication", parameters={"type": "phone"}
        )
        generator = generator_factory.create_generator(config)
        comm = generator.generate_single()
    ...
    def test_email_type(self, generator_factory):
        ...
        config = GeneratorConfig(
            generator_type="communication", parameters={"type": "email"}
        )
        generator = generator_factory.create_generator(config)
        comm = generator.generate_single()
    ...
    def test_social_media_type(self, generator_factory):
        ...
        config = GeneratorConfig(
            generator_type="communication", parameters={"type": "social_media"}
        )
        generator = generator_factory.create_generator(config)
        comm = generator.generate_single()
    ...
    def test_mixed_types(self, generator_factory):
        ...
        config = GeneratorConfig(
            generator_type="communication", parameters={"types": ["phone", "email"]}
        )
        generator = generator_factory.create_generator(config)
    ...
    def test_with_label(self, generator_factory):
        ...
        config = GeneratorConfig(
            generator_type="communication", parameters={"include_label": True}
        )
        generator = generator_factory.create_generator(config)
        comm = generator.generate_single()
