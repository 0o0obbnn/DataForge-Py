...
class TestCryptoGenerator:
    ...
    def test_generate_single(self, generator_factory):
        ...
        config = GeneratorConfig(generator_type="crypto", parameters={})
    ...
    def test_bitcoin_address(self, generator_factory):
        ...
        config = GeneratorConfig(
            generator_type="crypto", parameters={"type": "bitcoin_address"}
        )
        generator = generator_factory.create_generator(config)
    ...
    def test_ethereum_address(self, generator_factory):
        ...
        config = GeneratorConfig(
            generator_type="crypto", parameters={"type": "ethereum_address"}
        )
        generator = generator_factory.create_generator(config)
        address = generator.generate_single()
    ...
    def test_crypto_symbol(self, generator_factory):
        ...
        config = GeneratorConfig(generator_type="crypto", parameters={"type": "symbol"})
        generator = generator_factory.create_generator(config)
    ...
    def test_crypto_price(self, generator_factory):
        ...
        config = GeneratorConfig(generator_type="crypto", parameters={"type": "price"})
        generator = generator_factory.create_generator(config)
