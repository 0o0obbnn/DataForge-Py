...
@pytest.mark.skip(
    reason="Data relation derivation - advanced feature not fully implemented"
)
...
def test_dependency_ordering():
    ...
    relation_manager.add_relation_rule(
        RelationRule("idcard", "age", "derive", lambda x, y: {}, 10)
    )
    relation_manager.add_relation_rule(
        RelationRule("idcard", "gender", "derive", lambda x, y: {}, 10)
    )
    relation_manager.add_relation_rule(
        RelationRule("gender", "name", "constrain", lambda x, y: {}, 10)
    )
